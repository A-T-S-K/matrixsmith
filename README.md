...
- profile-derived content pipelines: verified one-frame Animation stills, semantic Auto/Still/Scroll text with bounded raster fallback, content-routed local image processing (Artwork, Photo, Pixel Art, Legacy), tiled pixel animation, and native GIF programs
