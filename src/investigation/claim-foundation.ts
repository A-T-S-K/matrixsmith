...
export const CLAIM_DEFINITIONS: readonly ClaimDefinition[] = Object.freeze([
  {
    id: "transport.bluetooth",
    label: "Bluetooth transport",
    category: "core",
    prerequisites: [],
    description: "FFF0/FFF1 GATT transport connects and accepts writes.",
  },
  {
    id: "protocol.coolledux",
    label: "Protocol identified",
    category: "core",
    prerequisites: ["transport.bluetooth"],
    description:
      "The CoolLEDUX protocol family answers the structured 0x1F query.",
  },
  {
    id: "device-info.query",
    label: "Device state",
    category: "core",
    prerequisites: ["protocol.coolledux"],
    description:
      "Device info (power, brightness) reads back as structured fields.",
  },
  {
    ...
    category: "core",
    prerequisites: ["protocol.coolledux"],
    description: "Brightness opcode 0x04 changes and reads back correctly.",
  },
  {
    id: "power.control",
    label: "Power",
    category: "optional",
    prerequisites: ["protocol.coolledux"],
    description: "Power opcode changes the panel's power state.",
  },
  {
    id: "stored-program.upload",
    label: "Stored-program upload",
    category: "content",
    prerequisites: ["protocol.coolledux"],
    description:
      "A compiled stored program is accepted and rendered by the device.",
  },
  {
    id: "stored-program.receipts",
    label: "Upload receipts",
    category: "optional",
    prerequisites: ["stored-program.upload"],
    description:
      "The device emits announce/chunk receipt notifications during upload.",
  },
  {
    id: "raster.tiling",
    label: "Raster tiling",
    category: "content",
    prerequisites: ["stored-program.upload"],
    description: "Tiled 8-column segments reconstruct the full canvas.",
  },
  {
    id: "raster.orientation",
    label: "Orientation",
    category: "content",
    prerequisites: ["raster.tiling"],
    description:
      "Corners and axes land where the logical framebuffer places them.",
  },
  {
    id: "graffiti.initial-render",
    label: "Static-image initial render",
    category: "content",
    prerequisites: ["stored-program.upload"],
    description: "A Graffiti program initially renders the intended raster.",
  },
  {
    id: "graffiti.playback-stability",
    label: "Static-image stability",
    category: "content",
    prerequisites: ["graffiti.initial-render"],
    contributesTo: ["static.strategy"],
    description:
      "A Graffiti raster stays still instead of scrolling or cycling.",
  },
  {
    id: "graffiti.black-semantics",
    label: "Static-image black",
    category: "content",
    prerequisites: ["graffiti.initial-render"],
    contributesTo: ["static.strategy"],
    description:
      "How the Graffiti path renders a literal 0x0000 pixel on this exact device.",
  },
  {
    id: "graffiti.color-mapping",
    label: "Static-image colors",
    category: "content",
    prerequisites: ["graffiti.initial-render"],
    description: "Graffiti pixel colors map to the intended channels.",
  },
  {
    id: "animation.frames",
    ...
    category: "content",
    prerequisites: ["stored-program.upload"],
    description: "Animation programs decode into distinct frames.",
  },
  {
    id: "animation.timing",
    label: "Animation timing",
    category: "content",
    prerequisites: ["animation.frames"],
    description:
      "Per-frame delays play at approximately the declared durations.",
  },
  {
    id: "animation.tile-sync",
    label: "Animation tile sync",
    category: "content",
    prerequisites: ["animation.frames"],
    description: "All tiles switch frames together with no lagging strip.",
  },
  {
    id: "animation.autonomous-loop",
    label: "Autonomous playback",
    category: "content",
    prerequisites: ["animation.frames"],
    description:
      "Animation keeps looping without further Bluetooth traffic. Distinct from power-cycle persistence.",
  },
  {
    id: "animation.black-semantics",
    label: "Animation black",
    category: "content",
    prerequisites: ["animation.frames"],
    contributesTo: ["static.strategy"],
    description:
      "How the Animation path renders a literal 0x0000 pixel on this exact device.",
  },
  {
    id: "animation.static-single-frame",
    label: "One-frame Animation raster",
    category: "content",
    prerequisites: ["animation.frames"],
    contributesTo: ["static.strategy"],
    description:
      "A one-frame Animation program renders a stable static raster.",
  },
  {
    id: "animation.static-identical-pair",
    label: "Identical-pair Animation raster",
    category: "content",
    prerequisites: ["animation.frames"],
    contributesTo: ["static.strategy"],
    description:
      "Two identical Animation frames render a stable static raster. Distinct from the one-frame variant.",
  },
  {
    id: "pixel.channel-map",
    label: "Raw channel mapping",
    category: "content",
    prerequisites: ["stored-program.upload"],
    contributesTo: ["static.strategy"],
    description:
      "Which nibbles of the 16-bit pixel word drive which physical channels — the raw wire behavior, regardless of what MatrixSmith's encoder assumes.",
  },
  {
    id: "pixel.encoder-correctness",
    label: "Encoder correctness",
    category: "content",
    prerequisites: ["pixel.channel-map"],
    contributesTo: ["static.strategy"],
    description:
      "Whether MatrixSmith's logical RGB values produce the intended physical channels. A characterized-but-permuted raw map means the encoder needs correction and keeps this rejected.",
  },
  {
    id: "pixel.fourth-channel",
    label: "Fourth channel",
    category: "content",
    prerequisites: ["pixel.channel-map"],
    description:
      "Whether the unused high nibble drives ANY fourth physical emitter, of whatever color.",
  },
  {
    id: "pixel.white-channel",
    label: "White channel",
    category: "content",
    prerequisites: ["pixel.fourth-channel"],
    description:
      "Whether the established fourth channel appears white. Existence of a fourth channel alone never verifies this.",
  },
  {
    id: "pixel.color-calibration",
    label: "Color calibration",
    category: "optional",
    prerequisites: ["pixel.channel-map"],
    description:
      "Whether rendered colors, including white, look visually correct.",
  },
  {
    id: "static.strategy",
    label: "Static-image strategy",
    category: "content",
    prerequisites: ["stored-program.upload"],
    description:
      "A usable strategy exists for showing a stable static image. DERIVED from the atomic strategy requirements (see static-viability.ts); direct evidence never decides it.",
  },
  {
    id: "text.rendering",
    label: "Text",
    category: "content",
    prerequisites: ["static.strategy"],
    description:
      "Rendered text displays correctly via the selected raster strategy.",
  },
  {
    id: "image.rendering",
    label: "Images",
    ...
    prerequisites: ["static.strategy"],
    description:
      "Imported images display correctly via the selected raster strategy.",
  },
  {
    id: "gif.playback",
    label: "GIF",
    category: "optional",
    prerequisites: ["stored-program.upload"],
    description: "Native GIF programs decode and play.",
  },
  {
    id: "power-cycle.persistence",
    label: "Power-cycle persistence",
    category: "optional",
    prerequisites: ["stored-program.upload"],
    description:
      "Stored content survives a physical power cycle. Not implied by autonomous looping.",
  },
  {
    id: "recovery.manual-reset",
    label: "Manual recovery",
    category: "optional",
    prerequisites: [],
    description: "A manual hardware reset restores default content.",
  },
]);

const DEFINITIONS_BY_ID = new Map(
  CLAIM_DEFINITIONS.map((definition) => [definition.id, definition]),
);
...
export function scopePriority(scope: EvidenceScope): number {
  return SCOPE_PRIORITY[scope];
}

export function resolveAtomicClaim(
  ...
  return {
    ...
    decidedBy,
    evidence: entries,
    blockedByPrerequisite: blockedBy,
  };
}
...
export const TRUSTED_OPERATIONAL_SCOPES: readonly EvidenceScope[] =
  Object.freeze(["current-session", "built-in-profile"]);
...
export function resolveTrust(
  ...
  resolveState: (
    id: ClaimId,
    evidence: readonly ClaimEvidence[],
  ) => ClaimState = (id, pool) => resolveAtomicClaim(claimDefinition(id), pool),
): OperationalTrust {
  ...
  const state = resolveState(id, trustedPool);
  const trusted = state.status === "verified";
  const untrusted = evidence.filter(
    (entry) => entry.claimId === id && !isTrustedScope(entry.scope),
  );
  const conflicting = untrusted.filter(
    (entry) =>
      (state.status === "verified" &&
        (entry.status === "rejected" || entry.status === "unresolved")) ||
...
/** Atomic trust used by strategy evaluation; broad strategy trust is derived by claims.ts. */
export function operationalTrust(
  id: ClaimId,
  evidence: readonly ClaimEvidence[],
): OperationalTrust {
  return resolveTrust(id, evidence);
}
